...
function appendEvent( event ) {
  ...
  if (event.tickets.includes("drd2NJDpck-5UGJImDFiPb8gPkddpdNHvVTRw9gH6aVUMjA5QVJGSEc4OTNRQ0JOMVlOTlNZMkdWVS4u") || event.tickets.includes("IAPFusion360") || event.tickets.includes("KVY44cREncNQquGkVYZUNktXODRMVU5KV01ZVUIxUlJGVUZJUEI4Ti4u") || event.tickets.includes("PresentingForEngineers")) {
